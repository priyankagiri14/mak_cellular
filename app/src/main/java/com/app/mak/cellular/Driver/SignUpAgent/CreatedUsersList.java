package com.app.mak.cellular.Driver.SignUpAgent;
...
public class CreatedUsersList extends AppCompatActivity implements UsersViewHolder.OnItemListener, NetworkStateReceiver.NetworkStateReceiverListener {
    ...
    private int imageid;
    List<com.app.mak.cellular.Driver.DriverAttendance.model.get_Agent.Body> list1;
    List<com.app.mak.cellular.Driver.DriverAttendance.model.get_Agent.Body> agent = new ArrayList<>();
    TextView noagents;
