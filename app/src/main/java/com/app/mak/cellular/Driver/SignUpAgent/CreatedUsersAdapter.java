...
public class CreatedUsersAdapter extends RecyclerView.Adapter<UsersViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(com.app.mak.cellular.Driver.DriverAttendance.model.get_Agent.Body item);
    }

    private List<FetchAgent> batchesGetLists;
    private List<com.app.mak.cellular.Driver.DriverAttendance.model.get_Agent.Body> bodyList;
